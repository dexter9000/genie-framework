package com.genie.core.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    private GenieProperties genieProperties;

    public CachingHttpHeadersFilter(GenieProperties genieProperties) {
        this.genieProperties = genieProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(genieProperties.getHttp().getCache().getTimeToLiveInDays());
    }
