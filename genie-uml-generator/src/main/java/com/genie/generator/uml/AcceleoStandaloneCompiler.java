...
public class AcceleoStandaloneCompiler {
    ...
    public void execute(String sourceFolder, String outputFolder){
        registerResourceFactories();
        registerPackages();
        registerLibraries();

        AcceleoCompilerHelper acceleoCompilerHelper = new AcceleoCompilerHelper();
        acceleoCompilerHelper.setSourceFolder(sourceFolder);
        acceleoCompilerHelper.setOutputFolder(outputFolder);
        acceleoCompilerHelper.setBinaryResource(false);
//        acceleoCompilerHelper.setDependencies("");
